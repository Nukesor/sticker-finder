...
def upgrade():
    ...
    op.create_index(
        op.f("ix_proposed_tags_chat_id"), "proposed_tags", ["chat_id"], unique=False
    )
    op.create_index(
        op.f("ix_proposed_tags_sticker_file_id"),
        "proposed_tags",
        ["sticker_file_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_proposed_tags_user_id"), "proposed_tags", ["user_id"], unique=False
    )
